...
def get_articles_update(filename, begin_date, end_date, clean=True):
    ...
    with open('/home/guillaume/Python_Projects/DST_DE_project/src/begin_date.txt', 'r') as read_begin_date:
    ...
    with open('/home/guillaume/Python_Projects/DST_DE_project/src/begin_date.txt', 'w') as outfile:
    ...
    if clean:
        ...
        with open(f"/home/guillaume/Python_Projects/DST_DE_project/src/{filename}", 'w') as outfile:
...
db = client.nyt
col = db['articles']
# results = col.insert_many(articles_update)